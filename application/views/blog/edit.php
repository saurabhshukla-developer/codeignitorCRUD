        <h3>Edit Blog</h3><hr>
        <a href="<?php echo base_url('blog/index') ?>" class="btn btn-default">Back</a><hr>
    <form action="<?php echo base_url('blog/update') ?>" method="post" class="form-horizontal">
        <input type="hidden" name="txt_hidden_id" value="<?php echo $blog->id; ?>">
            ...
            <label for="description" class="col-md-2 text-right">Description</label>
                <div class="col-md-10">
                    <textarea type="text" name="txt_description" class="form-control"><?php echo $blog->description; ?></textarea>
                </div>
            </div>
            <div class="form-group">
